...
export const DomainGroup = (props: DomainGroupProps) => (
  <div class="grid sm:grid-cols-[9rem_minmax(0,1fr)] sm:gap-2 sm:border-t sm:border-neutral-200 sm:py-1.5 sm:first:border-t-0 sm:first:pt-0 sm:last:pb-0 dark:sm:border-neutral-700/60">
    ...
    <div class="min-w-0 pt-1 pl-4 sm:pt-0 sm:pl-0">
      <Show
