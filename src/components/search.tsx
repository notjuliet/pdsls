...
const EXAMPLES: (RecentSearch & { prefix: string })[] = [
  ...
  {
    path: "/at://did:plc:uu5axsmbm2or2dngy4gwchec/sh.tangled.repo/3m2skfgqpvn22",
    label: "futur.blue/sh.tangled.repo/3m2skfgqpvn22",
    type: "at-uri",
    prefix: "at://",
  },
  { path: "/npmx.social", label: "npmx.social", type: "pds", prefix: "pds:" },
  {
    path: "/at://did:web:iame.li/com.atproto.lexicon.schema/place.stream.chat.message#schema",
    label: "place.stream.chat.message",
    type: "lexicon",
    prefix: "lex:",
  },
  {
