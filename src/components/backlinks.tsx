        ...
        {(group) => {
          ...
          return (
            <A
              ...
              class="flex items-center justify-between gap-3 rounded-lg border border-neutral-200 px-3 py-2 text-left hover:bg-neutral-200/50 dark:border-neutral-700 dark:hover:bg-neutral-800"
            >
      ...
      <For each={props.entries}>
        {(entry) => (
          <div class="overflow-hidden rounded-lg border border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center justify-between gap-3 border-b border-neutral-200 px-3 py-2 text-sm dark:border-neutral-700">
