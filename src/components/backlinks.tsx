        ...
        {({ did, collection, rkey }) => {
          ...
          return (
            <a
              ...
              class="grid grid-cols-[1fr_auto_auto] items-center gap-x-1 px-2 py-1.5 font-mono text-xs hover:bg-neutral-200/50 sm:gap-x-3 sm:px-3 dark:hover:bg-neutral-700/50"
            >
