      ...
      >
        ...
        <div class="flex w-full items-center gap-x-1 px-1">
          <textarea
            ...
            class="dark:bg-dark-100 dark:shadow-dark-800 grow rounded-lg border-[0.5px] border-neutral-300 bg-white px-2 py-1 shadow-xs focus:outline-[1px] focus:outline-neutral-600 dark:border-neutral-700 dark:focus:outline-neutral-400"
          />
