  ...
  const RepoTab = (props: { tab: Tab; label: string }) => (
    <button
      classList={{
        ...
        "bg-transparent hover:bg-light-700 dark:hover:bg-dark-400": tab() !== props.tab,
      }}
                ...
                <Show when={error()?.length === 0 || error() === undefined}>
                  <div class="flex items-center gap-1">
                    <button
                      ...
                      class="dark:hover:bg-dark-100 dark:bg-dark-300 focus:outline-1.5 flex items-center gap-1 rounded-lg bg-white px-2 py-1.5 text-xs font-bold shadow-md hover:bg-zinc-200 focus:outline-blue-500"
                    >
